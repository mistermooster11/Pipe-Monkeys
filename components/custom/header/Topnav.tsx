        ...
        <div className="bg-[#50B6EA] border-b border-[rgba(2,73,121,.2)] w-full">
            <div className="inner inner-header flex flex-row items-center justify-between min-h-[4.4rem] p-0">
                ...
                <div className="header__left hidden lg:block">
                    <a
                        href="tel:7187491830"
                        className="flex items-center gap-2 text-[#024979] text-[1.4rem] font-light tracking-[.05rem] py-[2rem] no-underline transition-colors duration-[350ms] hover:text-[#013560]"
                    >
                ...
                <div className="flex flex-wrap items-center py-[.8rem]">
                    <div className="hidden lg:flex mr-[1.5rem]">
                        <SocialLinks layout="row" theme="light" />
                    </div>
                    <button
                        onClick={onMobileMenuClick}
                        className="lg:hidden flex items-center justify-center ml-[1.3rem] bg-transparent border-0 cursor-pointer text-[#024979] p-[0.4rem]"
                        aria-label="Menu"
                    >
