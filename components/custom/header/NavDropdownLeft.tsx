        ...
        {dd.links.map((link, li) => (
          ...
          >
            ...
            >
              ...
              <span className="absolute -left-[1rem] right-0 -top-[1rem] -bottom-[1rem] bg-[rgba(254,254,240,.5)] opacity-0 transition-opacity duration-350 group-hover/link:opacity-100" />
